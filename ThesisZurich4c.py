...
print('newtags created')
newweigth = {(u,v,key) : data['length']/data['newwidth'] for u, v, key, data in g.edges(keys=True, data=True)}

nx.set_edge_attributes(g, newweigth, 'newweigth')

print('weigth created')

#add edges bc as tag

bb = nx.edge_betweenness_centrality(g, normalized=True, weight='newweigth')
...
ox.save_graphml(g, filepath="./data/zurichdietedlenghtwidthasweigth.graphml")
ox.save_graph_geopackage(g, filepath='./data/zurichdietedlengthwidthasweigth.gpkg', encoding='utf-8', directed=True)
