...
weigth = {(u,v,key) : data['length']/data['width'] for u, v, key, data in g.edges(keys=True, data=True)}

nx.set_edge_attributes(g, weigth, 'weigth')

print('weigth created')

#add edges bc as tag

bb = nx.edge_betweenness_centrality(g, normalized=True, weight='weigth')
...
ox.save_graphml(g, filepath="./data/zurichdietedD.graphml")
ox.save_graph_geopackage(g, filepath='./data/zurichdietedD.gpkg', encoding='utf-8', directed=True)
