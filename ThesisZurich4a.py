...
# to check that oneway tag makes sense, commented
'''
for u, v, data in g.edges(data=True):
...
ox.save_graphml(g, filepath="./data/zuirchdietednoweight.graphml")
ox.save_graph_geopackage(g, filepath='./data/zurichdietednoweight.gpkg', encoding='utf-8', directed=True)
